...
function ProductList({ onHomeClick }) {
    ...
    // Lấy danh sách sản phẩm trong Redux cart
            ...
            plants: [
                {
                    ...
                    description: "Can help deter certain insects.",
                    cost: "$10"
                },
                {
                    name: "Marigold",
                ...
                {
                    name: "Citronella",
                    image: "https://cdn.pixabay.com/photo/2018/06/17/18/50/grass-3485219_1280.jpg",
                    description: "Aromatic plant commonly used to repel mosquitoes.",
                    cost: "$16"
                },
                {
                    name: "Catnip",
...

        {
            ...
            plants: [
                ...
                },
                {
                    ...
                    description: "Often used for digestive issues and headaches.",
                    cost: "$13"
                },
                {
                    name: "Lemon Balm",
                ...
                },
                {
                    ...
                    description: "Commonly used as a relaxing herbal tea.",
                    cost: "$15"
                },
                {
                    name: "Calendula",
                    image: "https://cdn.pixabay.com/photo/2019/07/15/18/28/flowers-4340127_1280.jpg",
                    description: "Traditionally used for soothing skin.",
                    cost: "$12"
                }
            ]
        },

        {
            ...
            plants: [
                ...
                },
                {
                    ...
                    description: "Tolerates neglect and different growing conditions.",
                    cost: "$10"
                },
                {
                ...
                {
                    name: "Lucky Bamboo",
                    image: "https://cdn.pixabay.com/photo/2016/07/21/12/47/bamboo-1537420_1280.jpg",
                    description: "Easy-care plant suitable for indoor spaces.",
                    cost: "$16"
                }
            ]
        }
